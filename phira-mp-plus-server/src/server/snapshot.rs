...
pub(super) fn build_snapshot(
    ...
    RoomSnapshot {
        ...
        data: RoomData {
            ...
            playing_users,
            rounds: rounds.clone(),
            hidden: room.hidden.load(Ordering::SeqCst),
            ...
            live: room.live.load(Ordering::SeqCst),
            locked: room.locked.load(Ordering::SeqCst),
            cycling: room.cycle.load(Ordering::SeqCst),
            persistent_empty: room.persistent_empty.load(Ordering::SeqCst),

//! Telemetry batcher — high-frequency Touch/Judge batching infrastructure.
//!
//! Batches items by interval or batch-size threshold, then writes
//! via the synchronous DB ack path.
